...
def solve(tokens):
    ...
    tokens on the same line or different lines. It has the following methods:
    ...
    type; this will be passed into tokens.next_token (defaulting to str).
    Remove the tokens parameter if you won't need to extract any extra tokens.
    '''
